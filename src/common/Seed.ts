...
export const seedTasks: SerializedTask[] = [
  ...
  },
  {
    ...
    type: 'project',
    start_date: new Date(2025, 3, 11).toISOString(),
    duration: 8,
    progress: 0.6,
    parent: 1,
    open: true,
  },
  {
    ...
    type: 'project',
    start_date: new Date(2025, 3, 13).toISOString(),
    duration: 5,
    progress: 0.5,
    parent: 1,
    priority: 3,
  ...
  },
  {
    ...
    type: 'task',
    start_date: new Date(2025, 3, 3).toISOString(),
    duration: 7,
    progress: 0.6,
    parent: 2,
    priority: 1,
  ...
  },
  {
    ...
    type: 'task',
    start_date: new Date(2025, 3, 12).toISOString(),
    duration: 8,
    progress: 0.6,
    parent: 3,
  },
  {
    ...
    type: 'task',
    start_date: new Date(2025, 3, 14).toISOString(),
    duration: 5,
    progress: 0.5,
    parent: 4,
    priority: 1,
  },
  {
    ...
    type: 'task',
    start_date: new Date(2025, 3, 21).toISOString(),
    duration: 4,
    progress: 0.5,
    parent: 4,
  },
  {
    ...
    type: 'task',
    start_date: new Date(2025, 3, 27).toISOString(),
    duration: 3,
    progress: 0.5,
    parent: 4,
    priority: 2,
  ...
  },
  {
    ...
    text: 'Beta Release',
    type: 'milestone',
    start_date: new Date(2025, 3, 6).toISOString(),
    duration: 0,
    progress: 0,
    parent: 13,
  },
  {
    ...
    type: 'task',
    start_date: new Date(2025, 3, 10).toISOString(),
    duration: 2,
    progress: 0.8,
    parent: 13,
    priority: 3,
  ...
  },
  {
    ...
    text: 'Release v1.0',
    type: 'milestone',
    start_date: new Date(2025, 3, 18).toISOString(),
    duration: 0,
    progress: 0,
    parent: 11,
  },
